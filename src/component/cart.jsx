...
function Cart({img, h2, price}) {
  ...
  return (
    <div className='text-center min-[768px]:w-[200px] flex flex-col gap-[1em] relative items-center shadow-lg shadow-gray-100 pb-[1em] h-[350px] min-[1200px]:w-[250px] object-cover bg-white rounded-[1em]'>
        ...
        <img src={heart} className='absolute hover:scale-125 duration-[0.5s] text h-[30px] w-[30px] text-white text-[1.5rem] right-[0.5em] top-[0.5em]' alt="" />
        <img src={dis} className='absolute top-[0.7em] hover:scale-125 duration-[0.5s] left-[0.7em] w-[60px]' alt="" />
