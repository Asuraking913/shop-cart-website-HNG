...
function Bough({img, h2, price}) {
        return (
          <div className='text-center min-[768px]:w-[200px] flex flex-col gap-[1em] relative items-center shadow-lg shadow-gray-100 pb-[1em] h-[350px] min-[1200px]:w-[250px] object-cover bg-white rounded-[1em]'>
              ...
              <Link onClick={() => (window.scrollTo({top : 0, behavior : 'smooth'}))} className = "px-[1em] py-[0.5em] rounded-[10px] hover:scale-110 duration-[0.5s] border-[#e4b363] border-[1.5px] ">
                Add to cart
              </Link>
          </div>
)
 }
export default Bough