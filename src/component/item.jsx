  ...
  return (
    <div className='flex items-center gap-[2em] px-[2em]'>
        ...
        <div className='flex flex-col gap-[1em]'>
            ...
            <p className='w-[100%] min-[768px]:text-[0.8rem]'><span className='font-bold lora min-[768px]:text-[1.1rem] lg:text-xl '>Description: </span>{p}</p>
            ...
            <Link className='px-[1.5em] roboto min-[768px]:text-[1.1rem] lg:text-xl font-semibold w-[60%] py-[0.5em] border-[1.5px] rounded-[10px] border-[#e4b363]'>
                Remove Cart 
            </Link>
        </div>
    </div>
