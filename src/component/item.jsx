  ...
  return (
    <div className='flex items-center gap-[2em]'>
        ...
        <div className='flex flex-col gap-[1em]'>
            ...
            <p className='w-[80%]'><span className='font-bold lora text-xl '>Description: </span>{p}</p>
            ...
            <Link className='px-[1.5em] roboto text-xl font-semibold w-[50%] py-[0.5em] border-[1.5px] rounded-[10px] border-[#e4b363]'>
                Remove Cart 
            </Link>
        </div>
    </div>
