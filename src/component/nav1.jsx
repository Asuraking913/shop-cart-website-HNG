...
function Nav1({nav}) {
  if (nav === true) {
    return (
      <div className='z-50 lora bg-[#f5f5f5] font-semibold w-full text-3xl fixed top-0 flex sm:px-[--padx] px-[1.2em]  py-[0.4em] sm:py- justify-end items-center'>
          {/* <Link to={"/"} className='text-[--accent] lora italic font-bold'>
