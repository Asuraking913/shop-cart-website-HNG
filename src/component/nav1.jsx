...
function Nav1({cart}) {
  return (
    <div className='z-50 lora bg-[#f5f5f5] font-semibold w-full text-3xl fxed top-0 flex sm:px-[--padx] px-[1.2em]  py-[0.5em] sm:py-[--pady] justify-between items-center'>
        ...
        <ul className='flex gap-[2em] text-3xl text-[--accent]'>
            <Link className='hover:scale-110 hover:animate-pulse duration-[0.5s]'>
                {/* <img src={cart} className='h-[40px] w-[100px] object-cover' alt="" /> */}
                <div className='bas1 h-[80px] w-[100px]'></div>
            </Link>
        </ul>
